...
//						result.get(POIorig.getPlace_id()).put(POIdest.getPlace_id(), new ArrayList<UncertainValue>(24));
//					
//					float congestion_level = (float) Math.random();
//										
...
//	}
//	
//	public static Map<String, HashMap<String, ArrayList<UncertainValue>>> getCongestionLevelFromIDs(List<String> POIs) {
//		Map<String, HashMap<String, ArrayList<UncertainValue>>> result = new HashMap<String, HashMap<String, ArrayList<UncertainValue>>>();
//
...
//						result.put(POIorig, new HashMap<String, ArrayList<UncertainValue>>());
...
//					if (POIorig.equals(POIdest)) congestion_level = 0f;
//					else congestion_level = (float) Math.random();
//					
